  ...
  class axeConfig {
    getViolations() {
      try {
        ...
        throw new Error('wdio-axe encountered an error. Check the config and try to re run again.');
      }
    }
    ...
    analyseWithTag(tagArray) {
      ...
      try {
        if (typeof tagArray !== 'object') {
          response = false;
          throw new Error('wdio-axe needs input tags as Array.');
        }
    ...
    runConfig(config) {
      try {
        ...
        if (typeof config !== 'object') {
          throw new Error('wdio-axe needs an object to configure. See axe-core configure API.');
        }
